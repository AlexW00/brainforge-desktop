...
export function WorkspaceView() {
  ...
  const handleDragEnd = useCallback(
    ...
    [draggedViewId, resetDrag, removeView, splitView, views]
  )

  const renderView = useCallback(
    (viewId: string, gutterPositions: GutterPosition[]) => {
  ...
  const renderLayout = useCallback(
    (layout: Layout, parentGutterPositions: GutterPosition[] = []): React.ReactNode => {
      if ('viewId' in layout) {
